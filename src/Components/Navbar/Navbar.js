...
import resume from "../../Assetes/resume/Resume-Shekhar.pdf"
import {
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <a className='navbar-link'  download={resume}>Download Resume</a>
            </Nav>
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/shekhar-saini-420b241b4/"><img src={navIcon1} alt="" /></a>
